...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize Opinio to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with Opinio.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with Opinio as you scale.',
  },
  {
    title: 'Fast Support',
...
const FeaturesSection = () => {
  return (
    <section className="container mx-auto max-w-screen-xl px-4 my-24 flex items-center flex-col">
      <h2 className="mb-6 mt-10 text-2xl font-bold">Features</h2>
