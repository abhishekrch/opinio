      ...
      <div className="container mx-auto px-4 mb-24 mt-4 flex flex-col md:flex-row justify-center">
        <div className="flex flex-col max-w-sm justify-center">
          <div className="mb-8">
            ...
            <p className="text-gray-500 texl-lg">Easily integrate Opinio and start collecting feedback today.</p>
          </div>
          <div>
            <SignedOut>
              <SignUpButton>
        ...
        <div className="flex-1 max-w-lg">
          <Image src={'/opinio.gif'} alt="demo" layout={'responsive'} width={155} height={155} unoptimized={true} />
        </div>
      </div>
    </section>
  )
